(function ($) {
    ...
    var venueAddress = "Meralco Multi-Purpose Hall, Meralco Compound, Ortigas Avenue, Pasig City, Philippines", // Venue Address
        eventInfo = ["Congrats to the winners of the 2016 #WebGeekDevCup", "1st Place - Sentiment by JC Soriano", "2nd Place - flow by Animushub", "3rd Place - QuizMaker by Wings Gaming",
 "5th WebGeek DevCup Hackathon",]; // Event Info
